	  ...
	  function requestPay() {
		...
		IMP.init("imp33034306"); //가맹점 식별코드
		    ...
		    var makeMerchantUid = hours +  minutes + seconds + milliseconds;
		   	...
		   	var pay_total = $("#pay_total").val(100); //총합금액
...
<body>
	...
	<c:forEach var="cartList" items="${cartList }">
		<tr>
			...
			<td><input type="text"	value="${cartList.cart_price }" id="cart_price " name="cart_price ">
		</tr>
	</c:forEach>
	</table>
	<h1> 가게이름,주소 </h1>
	...
	<br>
		...
		요청사항
		<input type="text" name="pay_memo" value="요청사항없음" id="pay_memo"><br>

...
function check(){
	...
	// 개인정보동의
	var agree = document.fr.agree.value;
	if(agree == "동의안함"){ <% //아이디가 없으면 공백이 전달되므로%>
...
<!-- 	<h1> 회원가입 정보동의 및 개인 / 사업자 선택 </h1> -->
	<h1> 회원가입 정보동의 </h1>
	<p style="font-size:20px;" > Foodie Foly의 회원약관에 동의해주세요</p>
	
<div class="box1">
<h3>제1조(목적) </h3>
<p>이 약관은 푸디폴리(전자거래 사업자)이 운영하는 홈페이지(이하 "쇼핑몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 푸디폴리와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. </p>
...
② "쇼핑몰"과 이용자간에 제기된 전자거래 소송에는 한국법을 적용합니다. 
	...
	<fieldset>
		<form action ="UserJoin.lo" method="post" name ="fr"  onsubmit ="return check();">
			
			<div>
				동의 합니다.
				<input type="radio" name="agree" value="동의"> <br>
				동의하지 않습니다.  
				<input type="radio" name="agree" value="동의안함" checked> <br>
			</div>
			
			<div class="click-btn" align="center">
		<br>
			<input type ="submit" value="개인" >
			<input type ="button" value="사업자" onclick ="return check_agree();">

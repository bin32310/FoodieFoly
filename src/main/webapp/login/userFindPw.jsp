                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 item">
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s">
                            <h2 class="contact-form-title mb-30">개인 비밀번호 찾기</h2>
                            <!-- Contact Form -->
                            <form action="./UserFindPwAction.lo" method="post" name ="fr" onsubmit="return check();">
                                <div class="form-group">
                                    <input type="text" name ="us_name" class="form-control" id="contact-name" placeholder="이름(실명)">
                                </div>
                                <div class="form-group">
                                    <input type="text"  name ="us_id" class="form-control" id="contact-website" placeholder="아이디" >
                                </div>
                                <div class="form-group">

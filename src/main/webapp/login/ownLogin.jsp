                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-7 item">
                        <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s">
                            <h2 class="contact-form-title mb-30">사업자 로그인</h2>
                            <!-- Contact Form -->
                            <form action="./OwnLoginAction.lo" method="post" name ="fr" onsubmit="return check();">
                                <div class="form-group">
                                    <input type="text" name ="own_id" class="form-control" id="contact-name" placeholder="아이디">
                                </div>
                                <div class="form-group">
                                    <input type="password"  name ="own_pw" class="form-control" id="contact-website" placeholder="비밀번호" >
                                </div>

...
<body>
<!-- 	<h1> userDeletePwCheck.jsp(foly) </h1>
    <h1> (문의글) 삭제을 위한 비밀번호 입력 </h1> -->
    ...
    <fieldset>
        <form action ="./UserInfoContentDelete.us" method="post" name ="fr" style="text-align: center;">

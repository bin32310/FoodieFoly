...
<body>
  ...
  <!-- ****** Top Header Area Start ****** -->
	...
	<br>
		   ...
		   <form action ="MypagePwCheckAction.us" method="post" name ="fr" onsubmit="return check()" style="text-align: center;">

         <h6>  현재 비밀번호를 입력해주세요 </h6>
            <input type="password" name="us_pw"> 
				
            <input type ="submit" value="확인" style="background-color: #E56B8B; color: white; border: 1px solid white;">

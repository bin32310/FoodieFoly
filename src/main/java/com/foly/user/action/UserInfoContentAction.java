...
public class UserInfoContentAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println(" M :  UserInfoContentAction");
		...
		com.foly.user.db.UserqDAO dao = new UserqDAO();
		UserqDTO dto = dao.getQna(us_id);
		
		request.setAttribute("dto", dto);
		
		ActionForward forward = new ActionForward();
		forward.setPath("./user/userInfoContent.jsp");

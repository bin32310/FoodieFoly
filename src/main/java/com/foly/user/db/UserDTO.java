...
public class UserDTO {
	...
	// get and set 
	public int getUs_num() {
		return us_num;
	}
	public void setUs_num(int us_num) {
		this.us_num = us_num;
	}
	...
	public String toString() {
		return "UserDTO [us_num=" + us_num + ", us_id=" + us_id + ", us_pw=" + us_pw + ", us_name=" + us_name
				+ ", us_nick=" + us_nick + ", us_tel=" + us_tel + ", us_email=" + us_email + ", us_addr=" + us_addr
				+ ", us_birY=" + us_birY + ", us_birM=" + us_birM + ", us_birD=" + us_birD + ", us_order=" + us_order
				+ ", us_point=" + us_point + ", rvw_num=" + rvw_num + ", us_regdate=" + us_regdate + ", us_out="
				+ us_out + ", us_od=" + us_od + "]";
	}

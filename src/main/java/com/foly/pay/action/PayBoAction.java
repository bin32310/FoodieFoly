...
public class PayBoAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println(" M : PayBoAction 호출 ");
		...
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@"+request.getParameter("bo_date"));
		System.out.println("@@@@@@@@@@@@@@@@@@@@@@@"+request.getParameter("bo_dateH"));
		...
		String bo_dateH = request.getParameter("bo_dateH");
		...
		boDto.setBo_date(bo_date);
		boDto.setBo_dateH(bo_dateH);
		boDto.setBo_per(person);
		boDto.setRes_deposit(pay_total);
		//boDto.setRes_deposit(pay_total);

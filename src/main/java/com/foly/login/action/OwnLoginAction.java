...
/*
 * 	OwnLoginAction - 회원가입에 필요한 동작 처리
 ...
 *  
 * */
public class OwnLoginAction implements Action {
	
	@Override
	public ActionForward execute(HttpServletRequest request,
								HttpServletResponse response) throws Exception{
	
		System.out.println(" M : OwnLoginAction_execute() 호출 ");
...
//			request.setCharacterEncoding("UTF-8");
		 ...
		 //  3) DAO 객체 생성 - ownCheck(own_id,own_pw);
			LoginDAO dao = new LoginDAO();
			int result = dao.ownCheck(own_id,own_pw);

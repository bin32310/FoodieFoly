...
public class UserBookingDTO {
	...
	public String toString() {
		return "UserBookingDTO [us_id=" + us_id + ", own_id=" + own_id + ", own_name=" + own_name + ", res_name="
				+ res_name + ", res_exp=" + res_exp + ", res_tel=" + res_tel + ", res_addr=" + res_addr
				+ ", res_deposit=" + res_deposit + ", res_img=" + res_img + ", res_stH=" + res_stH + ", res_stM="
				+ res_stM + ", res_etH=" + res_etH + ", res_etM=" + res_etM + ", bo_value=" + bo_value + ", bo_num="
				+ bo_num + ", bo_date=" + bo_date + ", bo_dateH=" + bo_dateH + ", bo_per=" + bo_per + ", pk_num="
				+ pk_num + ", bo_state=" + bo_state + ", bo_menu=" + bo_menu + ", bo_count=" + bo_count + ", bo_price="
				+ bo_price + ", pay_num=" + pay_num + ", me_num=" + me_num + ", me_img=" + me_img + ", me_name="
				+ me_name + ", me_price=" + me_price + ", me_exp=" + me_exp + ", cart_num=" + cart_num + ", me_amount="
				+ me_amount + ", cart_menu=" + cart_menu + ", cart_amount=" + cart_amount + ", cart_price=" + cart_price
				+ ", cart_total=" + cart_price_total + ", rvw_num=" + rvw_num + "]";
	}

...
public class SearchDTO {
	...
	public String toString() {
		return "SearchDTO [own_id=" + own_id + ", own_pw=" + own_pw + ", own_name=" + own_name + ", own_tel=" + own_tel
				+ ", own_email=" + own_email + ", res_name=" + res_name + ", res_tel=" + res_tel + ", res_addr="
				+ res_addr + ", res_deposit=" + res_deposit + ", res_type=" + res_type + ", res_mng=" + res_mng
				+ ", res_stM=" + res_stM + ", res_stH=" + res_stH + ", res_etM=" + res_etM + ", res_etH=" + res_etH
				+ ", res_img=" + res_img + ", res_la=" + res_la + ", res_lo=" + res_lo + ", me_name=" + me_name
				+ ", me_img=" + me_img + ", own_regdate=" + own_regdate + ", own_out=" + own_out + ", own_od=" + own_od
				+ "]";
	}

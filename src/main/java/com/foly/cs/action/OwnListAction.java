...
public class OwnListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        int count = dao.getOwnCount();  // 글 개수 count 해주는 메서드
		...
		ArrayList<OwnMainDTO> ownList = null;
		if(count > 0) {
			ownList = dao.ownList(startRow, pageSize);
		}
		...
		forward.setPath("./cs/ownList.jsp");

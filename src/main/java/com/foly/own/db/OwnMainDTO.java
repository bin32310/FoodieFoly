...
public class OwnMainDTO {
	...
	private String res_la;
	private String res_lo;
	...
	public String getRes_la() {
		return res_la;
	}
	public void setRes_la(String res_la) {
		this.res_la = res_la;
	}
	public String getRes_lo() {
		return res_lo;
	}
	public void setRes_lo(String res_lo) {
		this.res_lo = res_lo;
	}
	@Override
	public String toString() {
		return "OwnMainDTO [own_id=" + own_id + ", own_pw=" + own_pw + ", own_name=" + own_name + ", own_tel=" + own_tel
				+ ", own_email=" + own_email + ", own_regdate=" + own_regdate + ", own_out=" + own_out + ", own_od="
				+ own_od + ", res_img=" + res_img + ", res_img_path=" + res_img_path + ", res_name=" + res_name
				+ ", res_tel=" + res_tel + ", res_addr=" + res_addr + ", res_deposit=" + res_deposit + ", res_type="
				+ res_type + ", res_la=" + res_la + ", res_lo=" + res_lo + ", res_mng=" + res_mng + ", res_stH="
				+ res_stH + ", res_stM=" + res_stM + ", res_etH=" + res_etH + ", res_etM=" + res_etM + ", me_img="
				+ me_img + ", me_img_path=" + me_img_path + "]";
	}
